...
function Card(props) {
    return (
        <div className='w-96 h-144 rounded-3xl drop-shadow-all'>
            ...
            <div className='h-[45%] w-full rounded-b-3xl bg-white p-6'>
                <div className='flex flex-col'>
                    <span className='text-3xl font-semibold'>Jorge Gomes</span>
                    <span className='text-2xl font-medium'>Jardineiro</span>
                    <span className='text-xl font-normal mt-1'>Faixa de Preço: R$100 - R$500</span>
                </div>
                ...
                <div id='avaliação' className='flex mt-3'>
                    <StarIconCheio className='w-5 h-5 text-yellow-500' />
                    <StarIconCheio className='w-5 h-5 text-yellow-500' />
                    <StarIconCheio className='w-5 h-5 text-yellow-500' />
                    <StarIconCheio className='w-5 h-5 text-yellow-500' />
                    <StarIconVazio className='w-5 h-5 text-yellow-500' />
                    <span className='text-sm ml-2 font-medium'>4.0</span>
                </div>
                <div className='flex mt-1 justify-center'>
                    <button className=' w-48 h-12 text-2xl bg-verde-padrao rounded-full text-white font-semibold'>CONTRATAR</button>
                </div>
            </div>
        </div>
    );
