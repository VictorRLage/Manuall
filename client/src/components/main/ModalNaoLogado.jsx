...
export default function ModalNaoLogado(props) {
        ...
        <div className='z-50 fixed h-screen w-screen top-0 bg-blur flex justify-center items-center'>
             <div className='relative h-64 w-100 bg-white rounded-lg flex flex-col items-center p-6'>
                ...
                <div className=' flex flex-col items-center py-4 gap-4'>
                    ...
                    <button onClick={props.onSwitchToModalEscolherCadastro} className='w-42 h-12 text-2xl bg-verde-padrao rounded-full text-white'>Cadastrar</button>
                </div>
            </div> 
        </div>
    );
