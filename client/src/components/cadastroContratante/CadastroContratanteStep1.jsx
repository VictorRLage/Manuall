      ...
      <div id="container_esquerda" className="bg-white h-full w-70per rounded-l-lg flex flex-col">
        ...
        <div id="container-inputs" className="2xl:w-112  xl:w-96 rounded-lg  self-center  2xl:justify-center grid 2xl:grid-cols-13.5x13.5 xl:grid-cols-11.5x11.5 2xl:gap-8 xl:gap-6 2xl:gap-x-4 xl:gap-x-4 2xl:mt-10 xl:mt-6">
          ...
          <div className="relative col-span-2">
            <input type="text" id="nome_inp" className="block px-2.5 pb-2.5 pt-4 w-full 2xl:text-lg xl:text-base text-gray-900 bg-transparent rounded-lg border-2 border-cinza-claro-1 appearance-none  focus:outline-none focus:ring-0 focus:border-verde-padrao peer" placeholder=" " />
          ...
          <div className="relative col-span-2">
            <input type="text" id="email_inp" className="block px-2.5 pb-2.5 pt-4 w-full 2xl:text-lg xl:text-base text-gray-900 bg-transparent rounded-lg border-2 border-cinza-claro-1 appearance-none  focus:outline-none focus:ring-0 focus:border-verde-padrao peer" placeholder=" " />
          ...
          <div className="relative col-span-2">
            <input type="text" id="senha_inp" className="block px-2.5 pb-2.5 pt-4 w-full 2xl:text-lg xl:text-base text-gray-900 bg-transparent rounded-lg border-2 border-cinza-claro-1 appearance-none  focus:outline-none focus:ring-0 focus:border-verde-padrao peer" placeholder=" " />
        ...
        <div id="container_proximo" className="w-full h-10 flex justify-end">
          <button className="2xl:text-2xl xl:text-xl 2xl:mr-12 xl:mr-11 2xl:mt-18 xl:mt-12.3 font-bold text-verde-padrao flex items-center" onClick={props.mudarStep}>Próximo <ChevronDoubleRightIcon className='2xl:h-10 2xl:w-10 xl:h-8 xl:w-8' /></button>
        </div>
      </div>
