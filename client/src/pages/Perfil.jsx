    ...
    return (
        <>
            ...
            <div className="w-full h-full z-10 " >
                ...
                <div id="section3" className="bg-white z-10 h-[33rem]  pl-32 pr-32 flex flex-col">
                    <svg className="absolute left-0 z-0" viewBox="0 0 1921 688" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M88.2861 11.7821C409.027 11.6157 1634.32 124.965 1933.66 10.8258C2233 -103.313 1918.7 787.962 1933.32 624.398C1947.93 460.835 463.651 825.224 87.9419 625.355C-287.767 425.485 -232.455 11.9485 88.2861 11.7821Z" fill="#008042" />
                    </svg>

                    <span className="mt-14 ml-36 mr-36 text-3xl font-bold z-10 text-white">Serviços oferecidos</span>
                    <div className="z-10 mr-36 ml-36 mt-10 text-white text-lg flex flex-col">
                        {servicos.map((data, i) => (
