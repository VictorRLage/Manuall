  ...
  return (
    ...
    <>
      ...
      <div className="flex flex-row">
        <span className="ml-[190px] mt-[40px]">
          <a href="./inicio" className="text-cinza">
            Página Inicial
          </a>
          /
      ...
      <div className="flex flex-row space-x-32 mt-[25px]" >
          ...
          <div className='contDados'>
            ...
            <div className='bg-verde-escuro-1'>
              <ul className='navbarCont'>
                <li><img className='w-[20px] ml-[10px] mt-[3px] align-middle' src='https://i.imgur.com/WOyvxEK.png'></img>  <spam className="ml-[10px]">11 92345-6978</spam></li>
                <li><img className='w-[20px] ml-[10px] mt-[3px] align-middle' src='https://i.imgur.com/iO24zKz.png'></img>  <spam className="ml-[10px]">Rua Haddock Lobo, 595 São Paulo - SP</spam></li>
                <li><img className='w-[20px] ml-[10px] mt-[3px] align-middle' src='https://i.imgur.com/fFBzUVk.png'></img>  <spam className="ml-[10px]">Segunda à sexta - 8h às 17h</spam></li>
              </ul>
            </div>
          </div>
        </div>
