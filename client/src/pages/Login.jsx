        ...
        <div className='flex justify-center h-screen font-mukta'>
            ...
            <div id='container' className=" bg-white 2xl:h-144 2xl:w-288 xl:h-120 xl:w-240 self-center rounded-lg drop-shadow-all flex flex-row">
                <div id="container_esquerda" className=" bg-verde-padrao h-full w-30per rounded-l-lg flex flex-col ">
                    ...
                    <button onClick={() => { navigate("/inicio") }} className='2xl:text-2xl xl:text-xl font-bold text-white self-center leading-relaxed 2xl:mt-11 xl:mt-9 flex items-center'> <ChevronDoubleLeftIcon className='2xl:h-10 2xl:w-10 xl:h-8 xl:w-8' /> Voltar à Tela inicial</button>
                </div>
                <div id='container_direita' className='bg-white h-full w-70per rounded-r-lg flex flex-col'>
                    ...
                    <div id="container_inputs" className="2xl:w-96  xl:w-80 rounded-lg  self-center flex flex-col 2xl:gap-10 xl:gap-8 2xl:mt-20 xl:mt-10 ">
                        ...
                        <div className="relative">
                            <input ref={senha_input} type="password" id="senha_inp" className={`block px-2.5 pb-2.5 pt-4 w-full 2xl:text-lg xl:text-base text-gray-900 bg-transparent rounded-lg border-2 appearance-none  focus:outline-none focus:ring-0 focus:border-verde-padrao peer`} placeholder=" " />
