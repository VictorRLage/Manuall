        ...
        <>
            ...
            <div className="w-full h-full">
                <div className="group">
                    <div
                        style={{
                            backgroundImage: `url(${slides[modalCurrentIndex].url})`,
                        }}
                        className="w-full h-120 bg-center bg-cover duration-500"
                    >
                        {modalCurrentIndex === 0 ? (
                            <div className="absolute">
                                <div className="absolute ml-20 mt-20 text-white text-6xl">
                                    Encontre <br /> prestadores de <br />{" "}
                                    serviço{" "}
                                    <span className="font-bold">
                                        excelentes
                                    </span>{" "}
                                    <br /> prontos para te <br />{" "}
                                ...
                                >
                                    <path
                                        d="M883 292.237C883 678.017 842.268 628.986 355.217 628.986C-988.334 628.986 -45.5207 664.039 -45.5207 391.338C-45.5207 118.638 -207.46 0.595234 109.373 0.595234C426.205 0.595234 883 -26.9222 883 292.237Z"
                                        fill="#008042"
                                    />
                                </svg>
                            </div>
                            ...
                            <div className="absolute flex">
                                <div className="absolute ml-[66rem] mt-20 text-white text-6xl text-right">
                                    Venha{" "}
                                    <span className=" font-bold">mudar</span>{" "}
                                    <br /> o mercado de <br />{" "}
                                    <span className="font-bold">
                                ...
                                >
                                    <path
                                        d="M1493.41 307.649C1493.41 693.19 1187.61 617.686 891.5 624.5C-303.5 652 78.5055 564.169 4.00007 141.5C-48.9945 -89.8309 589.006 6.66897 864.456 -25.1818C1140.6 -25.1818 1493.41 -11.3115 1493.41 307.649Z"
                                        fill="#008042"
                                    />
                                </svg>
                            </div>
                            ...
                            modalCurrentIndex === 2 && (
                                <div className="absolute flex justify-center">
                                    ...
                                    <svg
                                        className="ml-52 mt-3"
                                        width="1102"
                                        height="430"
                                        viewBox="0 0 1102 523"
                                        fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                                        <path
                                            d="M1102 258.803C1102 575.057 874.193 513.122 653.593 518.712C-236.658 541.27 60.9612 483.439 5.4562 136.729C-34.0237 -53.0297 441.274 26.1281 646.478 0.00128042C852.199 0.00128042 1102 -2.8374 1102 258.803Z"
                                            fill="#008042"
                                        />
                                    </svg>
                                </div>
                        ...
                        <div className="flex flex-row justify-between">
                            ...
                            <div
                                onClick={() => {
                                    setModalCurrentIndex(
                                        (modalCurrentIndex + 1) % slides.length,
                                    );
                                }}
                ...
                <div className="w-full flex p-32  flex-col">
                    <div className="w-full text-6xl font-semibold text-center">
                        Como{" "}
                        <span className="text-verde-padrao">contratar?</span>
                    </div>
                        ...
                        <div className="w-80 h-120 rounded-3xl drop-shadow-all">
                            ...
                            <div className="h-[40%] w-full rounded-b-3xl bg-white py-14 px-6 text-center">
                                <span className="text-2xl font-medium">
                                    ...
                                    e solicite o serviço (+ aula, se você
                                    quiser) em apenas 3 etapas!
                                </span>
                            </div>
                        </div>
                        <div className="w-80 h-120 rounded-3xl drop-shadow-all">
