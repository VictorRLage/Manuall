                ...
                <div className="bg-white h-full w-70per rounded-r-lg flex flex-col">
                    ...
                    <div className="2xl:w-96  xl:w-80 rounded-lg  self-center flex flex-col 2xl:gap-10 xl:gap-8 2xl:mt-20 xl:mt-10 ">
                        <div className="relative">
                            <input ref={email_input} onBlur={(e) => { checarEmail(e); }} onFocus={() => { setLoading(!loading); setCheck(false); setNotCheck(false); }} type="text" className={`block px-2.5 pb-2.5 pt-4 w-full 2xl:text-lg xl:text-base text-gray-900 bg-transparent rounded-lg border-2 ${validacaoEmail ? `border-cinza-claro-1` : `border-red-500`}  appearance-none  focus:outline-none focus:ring-0 focus:border-verde-padrao peer`} placeholder=" " />
