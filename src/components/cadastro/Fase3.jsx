                        ...
                        <div className="flex flex-col justify-around mt-8 gap-8 h-40 w-120 pr-12 pl-12  border-r-2  after:border-slate-300 border-slate-300">
                            ...
                            <div className="relative">
                                <div className="relative inline-block w-full">
                                    ...
                                    >
                                        <span>
                                            Selecione os serviços que você
                                            presta:
                                        </span>
                                    </button>
                                    <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                    ...
                    <div className="flex justify-center flex-col items-center w-full">
                        ...
                        <div className="flex flex-row w-full">
                            ...
                            <div className="w-full h-10 flex justify-end ">
                                <button
                                    onClick={avancar}
                                    className="bg-verde-escuro-2 2xl:w-40 2xl:h-12 xl:w-32 xl:h-11 rounded-full 2xl:text-2xl xl:text-xl 2xl:mr-16 xl:mr-12 2xl:mt-14 xl:mt-3 font-semibold text-white "
                                >
                                    Finalizar
                                </button>
                            </div>
