        ...
        >
            <div className="flex w-full h-[48px]">
                ...
                <div
                    className={`${
                        isOpen && "border-b-2"
                    } text-center border-r-2 border-[#00cc69] h-[48px] w-[20%] flex items-center justify-center`}
                >
                    {prestadorNome}
                </div>
                <div
                    className={`${
                        isOpen && "border-b-2"
                    } text-center border-r-2 border-[#00cc69] h-[48px] w-[40%] flex items-center justify-center`}
                >
                    {servico}
                </div>
                <div
                    className={`${
                        isOpen && "border-b-2"
                    } text-center border-[#00cc69] h-[48px] w-[20%] flex items-center justify-center`}
                >
